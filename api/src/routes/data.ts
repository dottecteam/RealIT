...
routerDados.post('/credit-risk', validateData(creditRiskSchema), criarCreditRisk)
routerDados.post('/inclusion-expansion', validateData(inclusionExpansionSchema), criarInclusionExpansion)
routerDados.post('/pix-structure', validateData(pixStructureSchema), criarPixStructure)
routerDados.post('/ibge-structure', validateData(ibgeStructureSchema), criarIbgeStructure)

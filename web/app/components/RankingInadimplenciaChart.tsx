...
import { RankingInadimplenciaChartProps } from "../types/components/RankingInadimplenciaChart"
...
export function RankingInadimplenciaChart({ ranking, taxaRegiao, taxaNacional, regiao }: RankingInadimplenciaChartProps) {
  ...
  const series = useMemo(() => [{ name: "Inadimplência Real", data: valores }], [valores])
